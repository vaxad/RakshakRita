        ...
        <div className="stationCard  lg:col-span-1 md:col-span-2 col-span-3 w-full">
            <div className="cardContents">
                ...
                <div className=" flex w-full justify-center items-center">
                    <Link href={`/feedback/${el._id}`} className="feedbackBtn bg-orange-500 flex justify-center items-center hover:scale-105 px-4 py-3 font-medium text-2xl text-slate-50 rounded-xl transition-all w-4/5  "> Give Feedback </Link>
                </div>
            </div>
        </div>
    )
